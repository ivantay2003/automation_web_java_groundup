...
public class Scenario2 {
 ...
 private void ValidateErrorMessage (){
	 ...
	 common.IsPresence(By.xpath(LOCELEMENT.LOC_ERROR1_XPATH));
	 String actualResult = driver.findElement(By.xpath(LOCELEMENT.LOC_ERROR1_XPATH)).getText();
	 System.out.println(actualResult);
	 
	 Assert.assertEquals(LOCELEMENT.ErrorMobilePhoneMissingString, actualResult);
 }
 @Test
 private void start (){
 ...
 private void Scenario1() {
	  ...
	  ValidateErrorMessage();//Check Error Message if submit fail
